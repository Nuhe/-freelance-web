const services = [
  ['Diseño y desarrollo', 'Una web clara, adaptable a celulares y alineada con la identidad de tu negocio.'],
  ...
  ['SEO técnico', 'Títulos, descripciones, estructura, sitemap e indexación preparados para Google.'],
    ...
    <section id="servicios" className="py-24 bg-zinc-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mb-14">
          ...
          <h2 className="section-title">Una web lista y acompañada</h2>
