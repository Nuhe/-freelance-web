...
const SOCIAL = [
  ...
  { label: 'LinkedIn', href: 'https://linkedin.com/in/Nuhe', icon: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
    </svg>
  )},
  { label: 'WhatsApp', href: 'https://wa.me/541134287724', icon: (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <footer className="bg-[#0c0c0c] border-t border-zinc-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid sm:grid-cols-[1fr_auto] gap-10 items-start mb-10">
          ...
          <div>
            ...
            <p className="text-zinc-700 text-xs font-mono max-w-xs leading-relaxed">
              Automatización, bots IA e integraciones para negocios<br />
              que quieren operar con más eficiencia y menos errores.
            </p>
          </div>
        ...
        <div className="border-t border-zinc-900 pt-6 flex flex-col sm:flex-row justify-between gap-2 text-[10px] font-mono text-zinc-800">
          ...
          <span className="text-zinc-900">Inteligencia ágil para negocios reales.</span>
        </div>
      </div>
    </footer>
  )
